...
P1_fn=c("P1_sec_30_40","P1_sec_70_80","P1_sec_90_105")#size 100,000,000

#print(load(paste0(savepath,"P_",name,"_",20,".RData")))
print("Adding blocks of FW105P1...")
library(Matrix)
p1_sz=20000#10000000#c(10000000,rep(20000000,3),30000000)#c(50000000,50000000)  #Work around the limit of max nnz(2^31)
P1_sz=200000#100000000# the size of the first part which is more dense
